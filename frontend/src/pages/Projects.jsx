...
function Projects() {
  ...
  useEffect(() => {
    const fetchRepos = async () => {
      try {
        const response = await fetch('https://api.github.com/users/YianXie/repos');
  ...
  return (
    <>
      ...
      <div className="intro">
        ...
        <p>
          These are some of the projects I have worked on. Most of them are personal projects, and a few of them are for school. I have worked on projects in a variety of languages and frameworks, including Python, JavaScript, and React.
          <br /><br />
          *Datas are fetched from my <a href="https://github.com/YianXie">GitHub account</a>.
        </p>
      </div>
        ...
        {repos.map((repo) => {
          ...
          return (
            <div
              ...
              onMouseEnter={() => fetchLanguages(repo.languages_url, repo.name)}
            ...
            >
              ...
              <div className="language-info">
                {langPercentages.length > 0 ? (
                  ...
                  <span className="language-badge">Loading...</span>
                )}
              </div>
            </div>
          );
